...
def extract_central_area(
    capacitor: Capacitor, charge: np.ndarray
) -> tuple[Capacitor, np.ndarray, np.ndarray]:
    """
    ...
    plate = Plate.from_square(side=new_plate_side, chunk_side=capacitor.chunk_side)
